...
STATE = os.path.join(os.path.dirname(__file__), ".masto-posted")
...
def post_masto(text):
    ...
    url = f"https://{inst}/api/v1/statuses"
    req = urllib.request.Request(
        url, data=json.dumps({"status": text, "visibility": "public"}).encode(),
